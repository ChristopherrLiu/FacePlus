...
class Client(Iface):
    ...
    def inferImage(self, image, width, height):
        ...
        """
        self.send_inferImage(image, width, height)
        return self.recv_inferImage()

    def send_inferImage(self, image, width, height):
        self._oprot.writeMessageBegin('inferImage', TMessageType.CALL, self._seqid)
    ...
    def recv_inferImage(self):
        ...
        raise TApplicationException(TApplicationException.MISSING_RESULT, "inferImage failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap = {}
        self._processMap["inferImage"] = Processor.process_inferImage
    ...
    def process_inferImage(self, seqid, iprot, oprot):
        ...
        result = inferImage_result()
        try:
            result.success = self._handler.inferImage(args.image, args.width, args.height)
...
class inferImage_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('inferImage_args')
...
all_structs.append(inferImage_args)
inferImage_args.thrift_spec = (
    None,  # 0
...
class inferImage_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('inferImage_result')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(inferImage_result)
inferImage_result.thrift_spec = (
